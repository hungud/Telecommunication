...
CREATE OR REPLACE TYPE CORP_MOBILE_LK.AVAILABLE_OPTION_TYPE AS OBJECT
(
...
CREATE OR REPLACE TYPE CORP_MOBILE_LK.AVAILABLE_OPTION_TAB AS TABLE OF AVAILABLE_OPTION_TYPE
/

CREATE OR REPLACE FUNCTION CORP_MOBILE_LK.AVAILABLE_OPTIONS_FOR_ABONENT(
  pUSER_ID IN INTEGER
...
FROM 
  ...
  CORP_MOBILE_LK.TARIFF_OPTION_ADD_INFO,
...
--select * from table(CORP_MOBILE_LK.AVAILABLE_OPTIONS_FOR_ABONENT(188220))
