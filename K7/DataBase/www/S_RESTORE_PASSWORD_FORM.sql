...
--Version#3
--
-- 3.Матюнин. Изменился механизм работы с каптчей.
-- 2 Крайнов. Установка не более 3-х попыток в сутки.
-- 1 Крайнов. Создание
  ParamCaptcha constant varchar2(32) := '6A2EA9E0CA6541DDBD2F0EAAE108FF22';-- новый публичный ключ --'C9CF53FCE96549A8AB703D7ADD481007'; -- Публичный ключ EXOCAPTCHA
