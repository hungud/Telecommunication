CREATE OR REPLACE PROCEDURE CORP_MOBILE.USER_NAMES_INSERT(
  ...
  p_ORGANIZATION_ID IN NUMBER default 3 
  ) IS

--#Version=8
-- 8. Соколов Добавлена обработка поля ORGANIZATION_ID
...
begin
  ...
  INSERT INTO USER_NAMES
    (USER_NAME_ID, USER_FIO, USER_NAME, FILIAL_ID, RIGHTS_TYPE, CHECK_ALLOW_ACCOUNT, ENCRYPT_PWD,user_name_oktel, PASSWORD_OKTEL, MAX_PROMISED_PAYMENT, ORGANIZATION_ID)
  VALUES
    (p_USER_NAME_ID, p_USER_FIO, UPPER(TRIM(p_USER_NAME)), p_FILIAL_ID, p_RIGHTS_TYPE, p_CHECK_ALLOW_ACCOUNT, p_ENCRYPT_PWD,user_oktel, p_PASSWORD_OKTEL, p_MAX_PROMISED_PAYMENT, p_ORGANIZATION_ID);
end;
/
