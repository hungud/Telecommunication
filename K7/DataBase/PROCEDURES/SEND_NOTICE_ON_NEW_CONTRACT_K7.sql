CREATE OR REPLACE PROCEDURE SEND_NOTICE_ON_NEW_CONTRACT(pCONTRACT_ID IN INTEGER) IS
  --
  --Version=1
  CURSOR C IS
...
--#if not GrantExists("SEND_NOTICE_ON_NEW_CONTRACT", "ROLE", "EXECUTE") then
begin EXECUTE IMMEDIATE 'GRANT EXECUTE ON SEND_NOTICE_ON_NEW_CONTRACT TO &MAIN_SCHEMA'||'_ROLE'; end;
--#end if

--#if not GrantExists("SEND_NOTICE_ON_NEW_CONTRACT", "ROLE_RO", "EXECUTE") then
begin EXECUTE IMMEDIATE 'GRANT EXECUTE ON SEND_NOTICE_ON_NEW_CONTRACT TO &MAIN_SCHEMA'||'_ROLE_RO'; end;
--#end if
