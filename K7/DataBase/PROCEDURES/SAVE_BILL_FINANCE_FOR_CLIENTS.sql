--#IF GETVERSION("SAVE_BILL_FINANCE_FOR_CLIENTS") < 1 THEN
CREATE OR REPLACE PROCEDURE SAVE_BILL_FINANCE_FOR_CLIENTS(
  pYEAR_MONTH IN INTEGER
  ) IS
--#Version=1  
--v1 —охранение(фиксаци€) детальных счетов по мес€ц
begin
  for rec in(
    select V.*
