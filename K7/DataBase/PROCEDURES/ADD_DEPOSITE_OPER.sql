--#if GetVersion("ADD_DEPOSITE_OPER") < 1 then
CREATE OR REPLACE PROCEDURE ADD_DEPOSITE_OPER (pCONTRACT_ID IN INTEGER, pDEPOSITE_VALUE IN NUMBER, pNOTE IN VARCHAR2) IS
--#Version=1
CURSOR C IS 
  SELECT COUNT(*) 
