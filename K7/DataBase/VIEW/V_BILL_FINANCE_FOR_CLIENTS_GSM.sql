CREATE OR REPLACE FORCE VIEW V_BILL_FINANCE_FOR_CLIENTS
--
--
--Version=2
--
   ...
   SELECT T1.ACCOUNT_ID,
     ...
     FROM (SELECT FB.ACCOUNT_ID,
            ...
            WHERE     c.phone_number_federal(+) = FB.phone_number
                  AND c.curr_tariff_id = tt.tariff_id(+)
                  and FB.phone_number = :PHONE_NUMBER
