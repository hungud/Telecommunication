...
--#Version=5
--
--v5. Алексеев. Добавил поле T.NOT_USE_REP_PHONE_WITHOUT_TRAF
--v4. Алексеев. Добавил поля C.CONTRACT_CANCEL_DATE, DB.PHONE_IS_ACTIVE AS PHONE_IS_ACTIVE_VALUE, DB.YEAR_MONTH YEAR_MONTH
