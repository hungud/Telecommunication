CREATE TABLE CALL_STATISTICS(
  ...
  CONSTRAINT PK_CALL_STATISTICS PRIMARY KEY
    (YEAR_MONTH, SUBSCR_NO, AT_FT_CODE)
  ) ORGANIZATION INDEX TABLESPACE HOT_BILLING;
...
COMMENT ON COLUMN CALL_STATISTICS.AT_C_DR_SC IS 'Длительность (сек.)';
COMMENT ON COLUMN CALL_STATISTICS.ZERO_COST_AT_C_DR_SC IS 'Длительность бесплатных (сек.)';
COMMENT ON COLUMN CALL_STATISTICS.AT_CDRRD_M IS 'Длительность (мин., с округлением)';
COMMENT ON COLUMN CALL_STATISTICS.ZERO_COST_AT_CDRRD_M IS 'Длительность бесплатных (мин., с округлением)';
...
GRANT DELETE, INSERT, SELECT, UPDATE ON CALL_STATISTICS TO CORP_MOBILE_ROLE;

GRANT SELECT ON CALL_STATISTICS TO CORP_MOBILE_ROLE_RO;