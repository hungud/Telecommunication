...
COMMENT ON TABLE CALL_2016_01 IS 'Детализации звонков за 2015 - 12';

COMMENT ON COLUMN CALL_2016_01.DBF_ID IS 'ID файла источника';
COMMENT ON COLUMN CALL_2016_01.SUBSCR_NO IS 'Сотовый номер';
COMMENT ON COLUMN CALL_2016_01.CH_SEIZ_DT IS 'Дата_время совершения звонка';
COMMENT ON COLUMN CALL_2016_01.US_SEQ_N IS 'Порядковый номер записи (служебное поле)';
COMMENT ON COLUMN CALL_2016_01.AT_SOC IS 'Услуга, по которой определяется тарификация';
COMMENT ON COLUMN CALL_2016_01.AT_FT_CODE IS 'Код звонка в билайне';
COMMENT ON COLUMN CALL_2016_01.PC_PLAN_CD IS 'Тарифный план';
COMMENT ON COLUMN CALL_2016_01.C_ACT_CD IS 'Тип вызова';
COMMENT ON COLUMN CALL_2016_01.AT_C_DR_SC IS 'Длительность (сек.)';
COMMENT ON COLUMN CALL_2016_01.AT_CDRRD_M IS 'Длительность (мин., с округлением)';
COMMENT ON COLUMN CALL_2016_01.AT_CHG_AMT IS 'Стоимость';
COMMENT ON COLUMN CALL_2016_01.CALLING_NO IS 'Номер инициатора звонка';
COMMENT ON COLUMN CALL_2016_01.MESSAGE_TP IS 'Тип записи: домашний или роуминг';
COMMENT ON COLUMN CALL_2016_01.SRV_FT_CD IS 'Сервис (код)';
COMMENT ON COLUMN CALL_2016_01.DATA_VOL IS 'Объем (для data)';
COMMENT ON COLUMN CALL_2016_01.IMEI IS 'IMEI (код)';
COMMENT ON COLUMN CALL_2016_01.CELL_ID IS 'Идентификатор соты';
COMMENT ON COLUMN CALL_2016_01.PROV_ID IS 'Роуминг-провайдер';
COMMENT ON COLUMN CALL_2016_01.DIALED_DIG IS 'Набранный номер';
COMMENT ON COLUMN CALL_2016_01.UOM IS 'Единица измерения';
COMMENT ON COLUMN CALL_2016_01.DISCT_SOCS IS 'Услуга-скидка';
COMMENT ON COLUMN CALL_2016_01.CALL_COST IS 'Стоимость Итоговая';
COMMENT ON COLUMN CALL_2016_01.MN_UNLIM IS 'Услуга-скидка';
COMMENT ON COLUMN CALL_2016_01.INSERT_DATE IS 'Дата вставки';
