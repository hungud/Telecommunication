...
alter table DB_LOADER_PHONE_STAT add (CALLS_COST_WITHOUT_API NUMBER (15, 2));
COMMENT ON COLUMN DB_LOADER_PHONE_STAT.CALLS_COST_WITHOUT_API IS 'Стоимость звонков без учета звонков загруженных из детализации по API';