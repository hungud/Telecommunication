...
alter table LOADER_CALL_N_LOG move tablespace TS_LOGS;
alter table LOADER_CALL_N_LOG move lob (FILE_BODY) store as (tablespace TS_LOGS);
Alter index PK_LOADER_CALL_N_LOG rebuild TABLESPACE TS_LOGS;
