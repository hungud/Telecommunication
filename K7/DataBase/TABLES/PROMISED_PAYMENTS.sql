...
BEGIN
  IF INSERTING THEN
    ...
    :NEW.PROMISED_SUM_ORIGINAL:=:NEW.PROMISED_SUM;
  END IF;  
...
ALTER TABLE PROMISED_PAYMENTS ADD PROMISED_SUM_ORIGINAL NUMBER(15, 2);

COMMENT ON COLUMN PROMISED_PAYMENTS.PROMISED_SUM_ORIGINAL IS 'Îðèãèíàëüíàÿ ñóììà îáåùàííîãî ïëàòåæà';