...
alter table ACCOUNT_LOAD_LOGS move tablespace TS_LOGS;
ALTER INDEX I_ACCOUNT_LOAD_LOGS_ACC_LOAD_D REBUILD TABLESPACE TS_LOGS;
ALTER INDEX I_ACCOUNT_LOAD_LOGS_BEELINE_RN REBUILD TABLESPACE TS_LOGS;
ALTER INDEX I_ACCOUNT_LOAD_LOGS_TYPE_ER_DT REBUILD TABLESPACE TS_LOGS;
ALTER INDEX PK_ACCOUNT_LOAD_LOGS REBUILD TABLESPACE TS_LOGS;

ALTER TABLE ACCOUNT_LOAD_LOGS ADD BAN INTEGER;
COMMENT ON COLUMN ACCOUNT_LOAD_LOGS.BAN IS 'Номер бана';