...
AS
   --#Version=4
   --
   --v4. Алексеев. Добавил очищение массивов в create_conn Tloader.DELETE;Theader.DELETE;
   --v3. Алексеев. Добавил проверку типа файла на пустоту NVL(FILES_LOAD_TYPES_ID, 1)
...
begin
  ...
  begin --забираем приложенные данные в blob для логирования
    ...
    select NVL(FILES_LOAD_TYPES_ID, 1)
    into pFileType 
