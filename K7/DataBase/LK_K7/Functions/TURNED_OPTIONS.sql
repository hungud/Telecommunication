...
/
GRANT SELECT ON DB_LOADER_ACCOUNT_PHONE_OPTS TO K7_LK;
/

CREATE OR REPLACE FUNCTION K7_LK.TURNED_OPTIONS(
  pUSER_ID IN INTEGER
...
-- select * from table(K7_LK.TURNED_OPTIONS(31688))
-- select * from table(K7_LK.TURNED_OPTIONS(134037))
