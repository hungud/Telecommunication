CREATE OR REPLACE FUNCTION GET_DISCR_ABON_ADD(
...
BEGIN
  ...
  LOOP
    ITOG:=ITOG + rec.MONTHLY_COST;
  END LOOP;                  
  RETURN ITOG;
END;  

GRANT EXECUTE ON GET_DISCR_ABON_ADD TO CORP_MOBILE_ROLE;

GRANT EXECUTE ON GET_DISCR_ABON_ADD TO CORP_MOBILE_ROLE_RO;