...
--create or replace directory HOT_BILL_LOG_DIR as 'D:\Tarifer\Svc\HotBilling\Logs';--для GSM;
...
--  VALUES (s_new_param_id.nextval, 'LOAD_LOGS_TIME_ERR', '2', 'B', 'Время для определения предупреждения, при ошибочных загрузках(ч)');  
--INSERT INTO params (param_id,name,value,type,descr) 
--   VALUES (s_new_param_id.nextval, 'HOT_BILL_ERR', 'CScript', 'B', 'Строка определяющая ошибки гор. биллинга');
--corp_mobile
--для К7
--INSERT INTO params (param_id,name,value,type,descr) 
--  VALUES (s_new_param_id.nextval, 'HOT_BILL_LOG_FILE', '%date%-success-Tarifer Hot Billing NikolayK7.log', 'N', 'Имя log-файла гор.биллинга');
--для GSM
--INSERT INTO params (param_id,name,value,type,descr) 
--  VALUES (s_new_param_id.nextval, 'HOT_BILL_LOG_FILE', '%date%-success-Tarifer Hot Billing gsmcorp.log', 'N', 'Имя log-файла гор.биллинга');
