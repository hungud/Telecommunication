CREATE OR REPLACE FUNCTION CORP_MOBILE.GET_PHONE_TARIFF_ID(
...
--#Version=5
--
-- v5. 23.11.2015 - Соколов. Исправил в курсоре C_TARIFFS сортировку с NVL(TARIFFS.TARIFF_PRIORITY, 9999) ASC на  NVL(TARIFFS.TARIFF_PRIORITY, 0) DESC
...
CURSOR C_TARIFFS IS
  SELECT TARIFF_ID
    ...
    ORDER BY NVL(TARIFFS.TARIFF_PRIORITY, 0) DESC;
--
