...
begin
  ...
  try
    ...
    mData.Lines.Text := AnsiReplaceStr(mData.Lines.Text, ';', #9);    //замена знака  ';' на tab    s1;
...
begin
//  Result := 'Оператор	Код дилера	Дилер	Номер	Тариф id	Тариф crm_id	Тариф	Дата заявки	Дата активации	Интрасеть';
