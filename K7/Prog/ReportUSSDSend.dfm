object ReportUSSDSendFrm: TReportUSSDSendFrm
  Left = 426
  Top = 230
  Caption = #1054#1090#1095#1077#1090' '#1086#1073' '#1086#1090#1087#1088#1072#1074#1083#1077#1085#1085#1099#1093' USSD'
  ClientHeight = 390
  ClientWidth = 826
  Color = clBtnFace
  ...
  object grData: TCRDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'ussd'
        Title.Caption = #1047#1072#1087#1088#1086#1089' '#1072#1073#1086#1085#1077#1085#1090#1072
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -11
        Title.Font.Name = 'MS Sans Serif'
  ...
  object qPeriods: TOraQuery
    ...
    SQL.Strings = (
        ...
        'select to_char(trunc(ul.ussd_date,'#39'mm'#39'),'#39'yyyymm'#39') as   YEAR_MONT' +
        'H,to_char(trunc(ul.ussd_date,'#39'mm'#39'),'#39'mm'#39')||'#39' - '#39'||to_char(trunc(u' +
        'l.ussd_date,'#39'mm'#39'),'#39'yyyy'#39') as YEAR_MONTH_NAME '
      'from ussd_log ul'
      'group by trunc(ul.ussd_date,'#39'mm'#39')'
      'ORDER BY 1 DESC')
    ReadOnly = True
    Left = 168
    Top = 112
