object ReportDiscountsFrm: TReportDiscountsFrm
  Left = 203
  Top = 134
  Caption = #1054#1090#1095#1105#1090' '#1086' '#1089#1082#1080#1076#1082#1077' '#1086#1087#1077#1088#1072#1090#1086#1088#1072
  ClientHeight = 401
  ClientWidth = 992
  Color = clBtnFace
  ...
  object qReport: TOraQuery
    SQL.Strings = (
      'SELECT * FROM V_DISCOUNT_REPORT'
      'WHERE YEAR_MONTH=:YEAR_MONTH'
      
        '      AND ((:ACCOUNT_ID IS NULL)OR(V_DISCOUNT_REPORT.ACCOUNT_ID=' +
        ':ACCOUNT_ID))')
    FetchRows = 250
    ReadOnly = True
