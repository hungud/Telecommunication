object ReportPromisedPaymentsForm: TReportPromisedPaymentsForm
  ...
  object qReport: TOraQuery
    SQL.Strings = (
      ...
      '       case'
      '         when pp.promised_date < sysdate then null'
      '         else '#39#1044#1077#1081#1089#1090#1074#1091#1102#1097#1080#1081#39
      '       end as priznak,'
      '       ACC.COMPANY_NAME,'
      '       pp.PROMISED_SUM_ORIGINAL       '
      '  FROM PROMISED_PAYMENTS pp, '
      '       db_loader_account_phones dbl, '
      '       accounts acc, '
      '       IOT_CURRENT_BALANCE'
    ...
    object qReportPROMISED_SUM2: TFloatField
      DisplayLabel = #1053#1077#1087#1086#1075#1072#1096#1077#1085#1085#1099#1081' '#1086#1089#1090#1072#1090#1086#1082
      FieldName = 'PROMISED_SUM'
      Required = True
    end
  end
