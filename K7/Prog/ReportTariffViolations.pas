...
type
  TReportTariffViolationsFrm = class(TForm)
    ...
    qAccountsCOMPANY_NAME2: TStringField;
    qAccountsACCOUNT_ID: TFloatField;
    qAccountsLOGIN: TStringField;
    qTariffViolationsACCOUNT_ID: TFloatField;
    qTariffViolationsCOMPANY_NAME: TStringField;
    qAccountsACCOUNT_NUMBER: TFloatField;
    qTariffViolationsACCOUNT_NUMBER: TFloatField;
