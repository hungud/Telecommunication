object ReportFinance: TReportFinance
  ...
  object qReportSimTradeGroup: TOraQuery
    SQL.Strings = (
      
        'SELECT KATEG, COUNT(KATEG) CNT1, SUM(FIN_RES) FIN_RES, SUM(PAYME' +
        'NTS_FULL) PAYMENTS_FULL1, SUM(PROFIT) PROFIT FROM (SELECT       ' +
        '        '
      'YEAR_MONTH,         '
      'PHONE_NUMBER,       '
      'BEELINE_BILL,       '
      ...
      'BALANCE_ON_BEGIN,   '
        ...
        'BALANCE_ON_BEGIN+NVL(PAYMENTS_FULL,0)-CLIENT_BILL BALANCE_ON_END' +
        ', '
      'CONTRACT_DATE,    '
      'CONTRACT_NUM,                                                '
      ...
      '  WHEN CLIENT_BILL<=0 THEN '#39#1053#1077' '#1080#1089#1087#1086#1083#1100#1079#1091#1102#1090#1089#1103#39'                    '
        ...
        '  WHEN (CONTRACT_DATE IS NULL) AND (CLIENT_BILL<>0) THEN '#39#1041#1077#1079' '#1082#1086 +
        #1085#1090#1088#1072#1082#1090#1086#1074#39' '
      '  WHEN (NVL(PAYMENTS_FULL,0)-CLIENT_BILL>0)  THEN '#39#1042#1089#1105' '#1054#1082#39' '
      
        '  WHEN (BALANCE_ON_BEGIN+NVL(PAYMENTS_FULL,0)-CLIENT_BILL<0) THE' +
        'N '#39#1059#1096#1083#1080' '#1074' '#1084#1080#1085#1091#1089#39' '
      '  ELSE '#39#1059#1084#1077#1085#1100#1096#1077#1085#1080#1077' '#1073#1072#1083#1072#1085#1089#1072#39'                  '
      'END KATEG,                                     '
      'NVL(PAYMENTS_FULL,0)-BEELINE_BILL FIN_RES,     '
      'CLIENT_BILL-BEELINE_BILL PROFIT                '
      'FROM V_DEBIT_AND_CREDIT                        '
      '  WHERE YEAR_MONTH=:YEAR_MONTH) GROUP BY Rollup(KATEG)')
    FetchRows = 500
    Left = 160
    Top = 240
    ParamData = <
