inherited RefAccountsForm: TRefAccountsForm
  ...
  inherited qMain: TOraQuery
    ...
    SQLInsert.Strings = (
      ...
      'VALUES'
        ...
        'MPANY_NAME, :FILIAL_ID, :new_pswd, :SMS_SENDER_NAME_ID)')
    SQLDelete.Strings = (
    ...
    object qMainPROVIDER_ID: TIntegerField
      FieldKind = fkLookup
      FieldName = 'PROVIDER_ID'
      LookupDataSet = qSMS_SEND_PARAM_BY_ACCOUNT
      LookupKeyFields = 'ACCOUNT_ID'
      LookupResultField = 'PROVIDER_ID'
      KeyFields = 'ACCOUNT_ID'
      Lookup = True
    end
  ...
  object qSMS_SEND_PARAM_BY_ACCOUNT: TOraTable
    TableName = 'SMS_SEND_PARAM_BY_ACCOUNT'
    OrderFields = 'PROVIDER_ID'
    Session = MainForm.OraSession
    Left = 40
    Top = 81
  end
  object qSMS_SEND_PARAMETRS: TOraTable
    TableName = 'SMS_SEND_PARAMETRS'
    OrderFields = 'PROVIDER_ID'
    Session = MainForm.OraSession
    Left = 48
    Top = 137
