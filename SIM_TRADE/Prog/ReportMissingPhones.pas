...
type
  TReportMissingPhonesForm = class(TForm)
    Panel1: TPanel;
    lPeriod: TLabel;
    lAccount: TLabel;
...
var
  ReportMissingPhonesForm: TReportMissingPhonesForm;

procedure DoReportMissingPhones;
...
procedure DoReportMissingPhones;
var ReportFrm : TReportMissingPhonesForm;
    Sdvig:integer;
begin
  ReportFrm:=TReportMissingPhonesForm.Create(Nil);
  try
    // Период
...
procedure TReportMissingPhonesForm.aExcelExecute(Sender: TObject);
var cr : TCursor;
begin
  cr := Screen.Cursor;
  Screen.Cursor := crHourGlass;
  try
    ExportDBGridToExcel2('Номера исчезнувшие с договоров за ' + cbPeriod.Text + ' по состоянию на '+DateToStr(Date),'',
...
procedure TReportMissingPhonesForm.aRefreshExecute(Sender: TObject);
begin
  qReport.Close;
  qReport.Open;
end;

procedure TReportMissingPhonesForm.aShowUserStatInfoExecute(
  Sender: TObject);
begin
...
procedure TReportMissingPhonesForm.cbAccountsChange(Sender: TObject);
var
  Account : integer;
begin
...
procedure TReportMissingPhonesForm.cbPeriodChange(Sender: TObject);
var Period : Integer;
begin
...
procedure TReportMissingPhonesForm.cbSearchClick(Sender: TObject);
begin
