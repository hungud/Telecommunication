...
begin
 ...
 FTarOpts.Caption:='Редактирования тарифа '+qmain.FieldByName('TARIFF_CODE').AsString+' и связанных опций';
...
begin
  ...
  Except
    ShowMessage('Ошибка при пересчёте баланса разблокировки.');
  end;
  ShowMessage('Баланс разблокировки пересчитан успешно.');
...
begin
  ...
  //показываем/скрываем столбец не игнор трафик для неактивности
