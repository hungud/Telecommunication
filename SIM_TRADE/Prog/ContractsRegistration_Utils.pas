...
begin
  ...
  try
    qS.SQL.Text:= 'SELECT MAX_PROMISED_PAYMENT FROM USER_NAMES WHERE USER_NAME = UPPER(:pUSER_NAME)';
...
begin
  ...
  begin
    ...
    try
      ...
      qS.ParamByName('pUSER_NAME').AsString := mainform.OraSession.Username;
      qS.Open;
