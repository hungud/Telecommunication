...
begin
  ...
  else qReport.ParamByName('ACCOUNT_ID').Clear;     // 31.10.12 А. Пискунов
end;
...
begin
  ...
  begin
    ...
    FiledNum := 0;
    InsertCol('Счет', 'ACCOUNT_NUMBER', FiledNum, 100);
    Inc(FiledNum);
    InsertCol('Название компании', 'COMPANY_NAME', FiledNum, 200);
  end
  else
