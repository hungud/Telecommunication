inherited RefUserNamesForm: TRefUserNamesForm
  ...
  object pAccounts: TPanel [3]
    ...
    object Label1: TLabel
      ...
      Height = 13
      Align = alTop
      Caption = #1044#1086#1089#1090#1091#1087#1085#1099#1077' '#1083#1080#1094#1077#1074#1099#1077' '#1089#1095#1077#1090#1072
    ...
    object gUser_Acc: TCRDBGrid
      ...
      TitleFont.Style = []
      OnDrawColumnCell = gUser_AccDrawColumnCell
      OnDblClick = gUser_AccDblClick
      Columns = <
        item
          Expanded = False
  ...
  inherited qMain: TOraQuery
    ...
    SQLInsert.Strings = (
      'begin'
        ...
        'D, :USER_NAME_OKTEL, :PASSWORD_OKTEL, :MAX_PROMISED_PAYMENT);'
      'end;')
    SQLDelete.Strings = (
      'begin'
  ...
  object qRightNames: TOraQuery [9]
    SQL.Strings = (
  ...
  object qUser_Accounts: TOraQuery
    ...
    SQL.Strings = (
      ...
      '  ac.ACCOUNT_NUMBER,'
      '  (SELECT USER_NAME_ID'
      '    FROM USER_NAME_ACCOUNTS '
      '    WHERE ACCOUNT_ID = ac.ACCOUNT_ID'
      '         AND USER_NAME_ID = :pUSER_NAME_ID ) UserN'
      'FROM ACCOUNTS ac')
    BeforeOpen = qUser_AccountsBeforeOpen
    Left = 728
    Top = 104
    ParamData = <
      item
    ...
    object qUser_AccountsACCOUNT_ID: TFloatField
      DisplayLabel = #1051#1080#1094#1077#1074#1086#1081' '#1089#1095#1077#1090
      FieldName = 'ACCOUNT_ID'
      Required = True
    end
    object qUser_AccountsACCOUNT_NUMBER: TFloatField
      DisplayLabel = #1053#1086#1084#1077#1088' '#1089#1095#1077#1090#1072
      FieldName = 'ACCOUNT_NUMBER'
    end
    object qUser_AccountsUSERN: TFloatField
      DisplayLabel = #1044#1086#1089#1090#1091#1087#1077#1085
      FieldName = 'USERN'
    end
  end
  object dsUser_Accounts: TDataSource
  ...
  object qNamberAccounts: TOraQuery
    Session = MainForm.OraSession
    SQL.Strings = (
      'SELECT *'
      'FROM USER_NAME_ACCOUNTS '
      'WHERE USER_NAME_ID = :pUSER_NAME_ID')
    BeforeOpen = qNamberAccountsBeforeOpen
    Left = 824
    Top = 168
    ParamData = <
      item
    ...
    object qNamberAccountsUSER_NAME_ID: TFloatField
      FieldName = 'USER_NAME_ID'
      Required = True
    end
    object qNamberAccountsACCOUNT_ID: TFloatField
      FieldName = 'ACCOUNT_ID'
      Required = True
    end
  end
