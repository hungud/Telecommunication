object ReportNumWithoutAbonPayFrm: TReportNumWithoutAbonPayFrm
  ...
  object grData: TCRDBGrid
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'BILL_SUM'
        Title.Alignment = taCenter
        Title.Caption = #1057#1091#1084#1084#1072' '#1087#1086' '#1089#1095#1105#1090#1091
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -11
        Title.Font.Name = 'MS Sans Serif'
  ...
  object qReport: TOraQuery
    SQL.Strings = (
      'SELECT * FROM  V_PAYMENTS_WITHOUT_TRAFFIC'
      '  WHERE V_PAYMENTS_WITHOUT_TRAFFIC.YEAR_MONTH=:YEAR_MONTH'
      
        '    AND ((:ACCOUNT_ID IS NULL)OR(V_PAYMENTS_WITHOUT_TRAFFIC.ACCO' +
        'UNT_ID=:ACCOUNT_ID) or (:ACCOUNT_ID=-1))')
    FetchRows = 250
    ReadOnly = True
    Left = 80
    Top = 112
  ...
  object qPeriods: TOraQuery
    SQL.Strings = (
      ...
      'FROM  V_PAYMENTS_WITHOUT_TRAFFIC'
      'GROUP BY YEAR_MONTH'
