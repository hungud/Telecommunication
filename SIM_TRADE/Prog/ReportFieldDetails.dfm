object ReportFieldDetailsForm: TReportFieldDetailsForm
  ...
  object qReportCM: TOraQuery
    SQL.Strings = (
      'SELECT TO_CHAR(TO_NUMBER(FIELD_DETAILS.FIELD_VALUE)) FIELD_VALUE'
      '  FROM FIELD_DETAILS'
      '  WHERE FIELD_DETAILS.FIELD_TYPE_ID=11'
      '    AND TO_NUMBER(FIELD_DETAILS.FIELD_VALUE) NOT IN '
      '        (SELECT BEELINE_BS_ZONES.BEELINE_BS_ZONE_ID'
      '           FROM BEELINE_BS_ZONES)'
      '    AND TO_NUMBER(FIELD_DETAILS.FIELD_VALUE)<=65000'
      '  ORDER BY TO_NUMBER(FIELD_DETAILS.FIELD_VALUE)')
    FetchAll = True
    Left = 120
    Top = 104
    object qReportCMFIELD_VALUE: TStringField
      DisplayLabel = #1041#1072#1079#1086#1074#1099#1077' '#1089#1090#1072#1085#1094#1080#1080
