BEGIN
  SYS.DBMS_SCHEDULER.CREATE_JOB
    (
      ...
      ,start_date      => TO_TIMESTAMP_TZ('2014/03/24 16:26:49.223000 +04:00','yyyy/mm/dd hh24:mi:ss.ff tzr')
      ...
      ,job_action      => 'begin
							...
							for c in (
							          select t.account_id 
									  from accounts t 
									  where nvl(t.is_collector,0)!=1
                                      and t.account_id not in (225,165)
									  and t.account_id not in (select distinct r.account_id 
