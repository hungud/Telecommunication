CREATE OR REPLACE PROCEDURE UNBLOCK_CLIENT_WTH_PLUS_BAL2(
...
BEGIN
  ...
  begin
  select strinlike('10',t.n_method,';','()') into nMethod from accounts t where t.account_id=pACCOUNT_ID;
  exception
...
--    
 ...
 VALUES(NEW_ACCOUNT_LOAD_LOG_ID, pACCOUNT_ID, SYSDATE,1,'', 10,null);commit; 
...
EXCEPTION
 ...
 INSERT INTO ACCOUNT_LOAD_LOGS(ACCOUNT_LOAD_LOG_ID, ACCOUNT_ID, LOAD_DATE_TIME,IS_SUCCESS, ERROR_TEXT, ACCOUNT_LOAD_TYPE_ID,BEELINE_RN)
 VALUES(NEW_ACCOUNT_LOAD_LOG_ID, pACCOUNT_ID, SYSDATE,0,err, 10,null);commit;
