CREATE OR REPLACE PACKAGE FTP_PKG AS
-- --------------------------------------------------------------------------
-- Name         : http://oracle-base.com/dba/miscellaneous/ftp.pks
-- Author       : Tim Hall
...
--                http://oracle-base.com/misc/site-info.php#copyright
-- Ammedments   :
--   When         Who       What
--   ===========  ========  =================================================
...
END FTP_PKG;
/
CREATE OR REPLACE PACKAGE BODY FTP_PKG AS
-- --------------------------------------------------------------------------
-- Name         : http://oracle-base.com/dba/miscellaneous/ftp.pkb
-- Author       : Tim Hall
-- Description  : Basic FTP API. For usage notes see:
--                  http://oracle-base.com/articles/misc/ftp-from-plsql.php
-- Requirements : http://oracle-base.com/dba/miscellaneous/ftp.pks
-- License      : Free for personal and commercial use.
--                You can amend the code, but leave existing the headers, current
--                amendments history and links intact.
--                Copyright and disclaimer available here:
