CREATE OR REPLACE package PKG_TRF_MEGAFON
is
...
CREATE OR REPLACE package body PKG_TRF_MEGAFON
is
 ...
 PKG_TRF_HTTPCLIENT.sURL := 'https://moscowsg.megafon.ru/ps/scc/php/check.php';
 ...
 /* Установка страницы */
 PKG_TRF_HTTPCLIENT.sURL := 'https://moscowsg.megafon.ru/SCWWW/BILLS_ORDER_FORM';
 ...
 when others then
 PKG_TRF_HTTPCLIENT.sERRORTEXT := 'Ошибка GET_PHONE_BILLS '||sqlerrm;
 end;
 ...
 /* Установка страницы */
 PKG_TRF_HTTPCLIENT.sURL := 'https://moscowsg.megafon.ru/SCWWW/ACCOUNT_INFO';
 ...
 /* если ошибка в блоке - тогда генерация сообщения */
 when others then
 PKG_TRF_HTTPCLIENT.sERRORTEXT := 'Ошибка GET_PHONE_STATUS '||sqlerrm;
 end;
 ...
 /* Установка страницы */
 PKG_TRF_HTTPCLIENT.sURL := 'https://moscowsg.megafon.ru/SCWWW/ORDER_SERVICE_FORM';
 ...
 /* если ошибка в блоке - тогда генерация сообщения */
 when others then
 PKG_TRF_HTTPCLIENT.sERRORTEXT := 'Ошибка GET_PHONE_OPTIONS '||sqlerrm;
 Result := PKG_TRF_HTTPCLIENT.sERRORTEXT;
 end;
 ...
 exception
 when others then
 PKG_TRF_HTTPCLIENT.sERRORTEXT := 'Ошибка SET_PHONE_OPTION_ON '||sqlerrm;
 Result := PKG_TRF_HTTPCLIENT.sERRORTEXT;
 end;
 ...
 /* Установка страницы */
 PKG_TRF_HTTPCLIENT.sURL := 'https://moscowsg.megafon.ru/SCWWW/ORDER_SERVICE_CONFIRM';
 ...
 exception
 when others then
 PKG_TRF_HTTPCLIENT.sERRORTEXT := 'Ошибка ORDER_SERVICE_CONFIRM '||sqlerrm;
 Result := PKG_TRF_HTTPCLIENT.sERRORTEXT;
 end;
 ...
 begin
 /* Установка страницы */
 PKG_TRF_HTTPCLIENT.sURL := 'https://moscowsg.megafon.ru/SCWWW/ORDER_SERVICE_ACTION';
 ...
 exception
 when others then
 PKG_TRF_HTTPCLIENT.sERRORTEXT := nvl(PKG_TRF_HTTPCLIENT.sERRORTEXT,'Ошибка ORDER_SERVICE_ACTION '||sqlerrm);
 end;
 ...
 exception
 when others then
 PKG_TRF_HTTPCLIENT.sERRORTEXT := 'Ошибка SET_PHONE_OPTION_OFF '||sqlerrm;
 end;
