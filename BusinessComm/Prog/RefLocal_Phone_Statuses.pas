...
type
  TRefLocal_Phone_StatusesForm = class(TRefForm)
...
var
  RefLocal_Phone_StatusesForm: TRefLocal_Phone_StatusesForm;

implementation

{$R *.dfm}

procedure TRefLocal_Phone_StatusesForm.FormCreate(Sender: TObject);
begin
  qRef := dm.qLocal_Phone_Statuses;
  inherited;
  qRef.OnDeleteError := qRefDeleteError;
end;

procedure TRefLocal_Phone_StatusesForm.qRefDeleteError(DataSet: TDataSet; E: EDatabaseError;
