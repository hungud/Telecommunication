...
begin
 if mainform.OraSession.Password <> old_pwd.text then begin
 ...
 try
   alter_user_encrypt_pwd.ParamByName('p_USER_NAME').AsString:=mainform.OraSession.Username;
   alter_user_encrypt_pwd.ParamByName('p_PASSWORD').AsString:=mainform.md5_30(new_pwd.text);
