CREATE OR REPLACE FUNCTION GET_TARIFF_OPTION_ADD_COST2(
...
--Version=4
--
--v4. Афросин 02,12,2014 - добавил строку AND V.DATE_BEGIN < nvl(PO.TURN_OFF_DATE, V.DATE_BEGIN +1) 
--
  CURSOR C IS
    SELECT PO.TURN_ON_DATE,
      ...
      WHERE PO.ACCOUNT_ID = pACCOUNT_ID
        ...
        AND V.DATE_BEGIN < nvl(PO.TURN_OFF_DATE, V.DATE_BEGIN +1) 
