CREATE OR REPLACE FUNCTION WWW_GET_PHONE_DETAIL_DB(
...
--    WHERE pCONTRACT_ID=CONTRACTS.CONTRACT_ID;
  ...
  SELECT DETAIL_LK_TYPE(SUBSCR_NO) BULK COLLECT INTO vDETAIL_LK_TAB FROM CALL_12_2012 CL WHERE SUBSCR_NO=pPHONE_NUMBER_FEDERAL;
  RETURN vDETAIL_LK_TAB; 
END;
/

GRANT EXECUTE ON WWW_GET_PHONE_DETAIL_DB TO CORP_MOBILE;
GRANT EXECUTE ON WWW_GET_PHONE_DETAIL_DB TO CORP_MOBILE_LK;
/       