...
COMMENT ON COLUMN HOT_BILLING_CALLS_DUPLICATE.DURATION IS 'Длительность';
...
COMMENT ON COLUMN HOT_BILLING_CALLS_DUPLICATE.DUR IS 'Длительность(сек)';

COMMENT ON COLUMN HOT_BILLING_CALLS_DUPLICATE.MN_UNLIM IS 'Услуга-скидка';



CREATE INDEX I_HB_DC$SUBSCR_NO$AT_FT_CODE ON HOT_BILLING_CALLS_DUPLICATE
...
CREATE INDEX I_HB_DUPL_CALLS$DBF_ID ON HOT_BILLING_CALLS_DUPLICATE
(DBF_ID)
LOGGING
TABLESPACE HOT_BILLING
PCTFREE    10
...
CREATE UNIQUE INDEX PK_HOT_BILLING_DUPLICATE_CALLS ON HOT_BILLING_CALLS_DUPLICATE
...
GRANT DELETE, INSERT, SELECT, UPDATE ON HOT_BILLING_CALLS_DUPLICATE TO LONTANA_ROLE;

GRANT SELECT ON HOT_BILLING_CALLS_DUPLICATE TO LONTANA_ROLE_RO;
