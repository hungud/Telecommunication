...
Insert into CONSTANTS
   (NAME, DESCR, TYPE, VALUE, ACCESS_VERSTION_STRING)
 Values
   ('EXPORT_OBJECTS_TO_SVN_PATH', 'Путь для выгрузки файлов скриптов Базы данных', 'S', 'D:\Tarifer\VersionControl\Database',  '1.8.26.76');
COMMIT;
...
INSERT INTO CONSTANTS (NAME, DESCR, TYPE, ACCESS_VERSTION_STRING) 
VALUES ('USER_LAST_CRM_REQUEST_UNLOCK', 'Пользователь, который последний выполнял заявку на разблок в CRM от IVR', 'S', '0.0.0.0');
COMMIT; 
...
Insert into CONSTANTS
 ...
 Values
   ('COUNT_STREAM_HOT_BILLING', 'Кол-во потоков для загрузки гор.биллинга', 'N', '1');

Insert into CONSTANTS
   (NAME, DESCR, TYPE, VALUE, 
    ACCESS_VERSTION_STRING)
 Values
   ('VAT', 'НДС (налог на добавленную стоимость)', 'N', '1.18','1.8.30.8');

INSERT INTO CONSTANTS (NAME, DESCR, TYPE, VALUE, ACCESS_VERSTION_STRING)
  VALUES ('CRM_BEELINE_RESPONSIBLE_USER', 'Ответственный пользователь для ручного провердения платежей по CRM-заявкам', 'S', 'MTSMEGAFON', '0.0.0.0');
