...
ALTER TABLE OPERATORS ADD OPERATOR_FOR_CHAT VARCHAR2(30 CHAR);

COMMENT ON COLUMN OPERATORS.OPERATOR_FOR_CHAT IS 'Наименование оператора на английском (исп. при определении оператора в чата)';
			   
CREATE SYNONYM WWW_DEALER.OPERATORS FOR LONTANA.OPERATORS;

GRANT SELECT, INSERT ON LONTANA.OPERATORS TO WWW_DEALER;