...
COMMENT ON COLUMN TARIFFS.SHOW_TO_USER_FOR_ADD_CONTR IS 'Показывать тариф пользователям, без админских прав, при заведении нового договора';

ALTER TABLE TARIFFS ADD ACCESS_UNLOCK_SAVE NUMBER(1) DEFAULT 1;  

COMMENT ON COLUMN TARIFFS.ACCESS_UNLOCK_SAVE IS 'Разрешен ли разблок данного тарифа из сохранения.';

ALTER TABLE TARIFFS ADD NUMBER_TARIFF_IVR INTEGER;
COMMENT ON COLUMN TARIFFS.NUMBER_TARIFF_IVR IS 'Номер тарифа в голосовом меню IVR при активации телефона';
