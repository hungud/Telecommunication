create or replace and compile java source named LZMADecoder as
...
public class Decoder
{
  class LenDecoder
  {
    ...
    public void Init()
    {
      Decoder1.InitBitModels(m_Choice);
    ...
    public int Decode(Decoder1 rangeDecoder, int posState) throws IOException
    {
  ...
  class LiteralDecoder
  {
    class Decoder2
    {
      ...
      public void Init()
      {
        Decoder1.InitBitModels(m_Decoders);
      }
      
      public byte DecodeNormal(Decoder1 rangeDecoder) throws IOException
      {
        int symbol = 1;
        do
      ...
      public byte DecodeWithMatchByte(Decoder1 rangeDecoder, byte matchByte) throws IOException
      {
        int symbol = 1;
        do
        {
  ...
  Decoder1 m_RangeDecoder = new Decoder1();
  ...
  void Init() throws IOException
  {
    ...
    Decoder1.InitBitModels(m_IsMatchDecoders);
    Decoder1.InitBitModels(m_IsRep0LongDecoders);
    Decoder1.InitBitModels(m_IsRepDecoders);
    Decoder1.InitBitModels(m_IsRepG0Decoders);
    Decoder1.InitBitModels(m_IsRepG1Decoders);
    Decoder1.InitBitModels(m_IsRepG2Decoders);
    Decoder1.InitBitModels(m_PosDecoders);
