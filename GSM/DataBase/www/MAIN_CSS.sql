CREATE OR REPLACE PROCEDURE LONTANA_WWW.MAIN_CSS(
...
#header h1 {position: absolute; left: 366px; top: 50px; line-height: 100%; font-family: ''Euros'';}
...
/* активная закладка */
/* старое
#tab_menu #active_tab {display: block; height: 31px; margin-top: 5px; background: url("img_active_tab_left") left bottom no-repeat; white-space: nowrap;}
#tab_menu #active_tab span {display: block; color: #000; height: 27px; padding: 4px 20px 0px 0px; margin-left: 20px; background:  url("img_active_tab_right") right bottom no-repeat;}
 старое */
 
#tab_menu #active_tab {display: block; height: 31px; margin-top: 5px; background: url("img_active_tab_left") left bottom no-repeat; white-space: nowrap;}
#tab_menu #active_tab span {display: block; color: #000; height: 27px; padding: 4px 17px 0px 0px; margin-left: 17px; background: #fff url("img_active_tab_right") right bottom no-repeat;}
/* /активная закладка */
/* /главное меню-закладки */
...
#content table thead td {height: 35px; line-height: 35px; padding: 0px 10px; font-size: 12pt; font-family : ''Euros''}
...
#content a.balance_info {display: inline-block; width: 168px; height: 28px; background: url("img_balance_info_bg_2") left top no-repeat; font-size: 9pt; font-weight: bold; color: #fff; text-align: center; line-height: 28px; text-decoration: none; margin-left: 20px;}
...
#auth_form_container #auth_from_close_button {width: 16px; height: 16px; position: absolute; top: 10px; right: 20px; background-image: url("img_auth_form_close_button_2"); background-position: 0px 0px;}
...
#auth_form #reload_captcha {font-size: 9pt; float: left; background: url("img_reload_captcha_icon_2") left top no-repeat; padding-left: 20px; text-decoration: none;}
#auth_form #reload_captcha span {border-bottom: 1px dotted #009696;} /*#f5b93f*/
...
.progress{height:30px;margin-bottom:5px;overflow:hidden;background-color:#DADFE2;border-radius:4px;-webkit-box-shadow:inset 0 1px 2px rgba(0,0,0,0.1);box-shadow:inset 0 1px 2px rgba(0,0,0,0.1);position: relative;}
.progress-bar{
    float:left;
    width:0;
    height:100%;
...
.progress-striped 
.progress-bar-success{background-image:-webkit-gradient(linear,0 100%,100% 0,color-stop(0.25,rgba(255,255,255,0.15)),color-stop(0.25,transparent),color-stop(0.5,transparent),color-stop(0.5,rgba(255,255,255,0.15)),color-stop(0.75,rgba(255,255,255,0.15)),color-stop(0.75,transparent),to(transparent));background-image:-webkit-linear-gradient(45deg,rgba(255,255,255,0.15) 25%,transparent 25%,transparent 50%,rgba(255,255,255,0.15) 50%,rgba(255,255,255,0.15) 75%,transparent 75%,transparent);background-image:-moz-linear-gradient(45deg,rgba(255,255,255,0.15) 25%,transparent 25%,transparent 50%,rgba(255,255,255,0.15) 50%,rgba(255,255,255,0.15) 75%,transparent 75%,transparent);background-image:linear-gradient(45deg,rgba(255,255,255,0.15) 25%,transparent 25%,transparent 50%,rgba(255,255,255,0.15) 50%,rgba(255,255,255,0.15) 75%,transparent 75%,transparent)}
.progress-bar-info{background-color:#5bc0de}
.progress-striped .progress-bar-info{background-image:-webkit-gradient(linear,0 100%,100% 0,color-stop(0.25,rgba(255,255,255,0.15)),color-stop(0.25,transparent),color-stop(0.5,transparent),color-stop(0.5,rgba(255,255,255,0.15)),color-stop(0.75,rgba(255,255,255,0.15)),color-stop(0.75,transparent),to(transparent));background-image:-webkit-linear-gradient(45deg,rgba(255,255,255,0.15) 25%,transparent 25%,transparent 50%,rgba(255,255,255,0.15) 50%,rgba(255,255,255,0.15) 75%,transparent 75%,transparent);background-image:-moz-linear-gradient(45deg,rgba(255,255,255,0.15) 25%,transparent 25%,transparent 50%,rgba(255,255,255,0.15) 50%,rgba(255,255,255,0.15) 75%,transparent 75%,transparent);background-image:linear-gradient(45deg,rgba(255,255,255,0.15) 25%,transparent 25%,transparent 50%,rgba(255,255,255,0.15) 50%,rgba(255,255,255,0.15) 75%,transparent 75%,transparent)}
.progress-bar-warning{background-color:#f0ad4e}
.progress-striped .progress-bar-warning{background-image:-webkit-gradient(linear,0 100%,100% 0,color-stop(0.25,rgba(255,255,255,0.15)),color-stop(0.25,transparent),color-stop(0.5,transparent),color-stop(0.5,rgba(255,255,255,0.15)),color-stop(0.75,rgba(255,255,255,0.15)),color-stop(0.75,transparent),to(transparent));background-image:-webkit-linear-gradient(45deg,rgba(255,255,255,0.15) 25%,transparent 25%,transparent 50%,rgba(255,255,255,0.15) 50%,rgba(255,255,255,0.15) 75%,transparent 75%,transparent);background-image:-moz-linear-gradient(45deg,rgba(255,255,255,0.15) 25%,transparent 25%,transparent 50%,rgba(255,255,255,0.15) 50%,rgba(255,255,255,0.15) 75%,transparent 75%,transparent);background-image:linear-gradient(45deg,rgba(255,255,255,0.15) 25%,transparent 25%,transparent 50%,rgba(255,255,255,0.15) 50%,rgba(255,255,255,0.15) 75%,transparent 75%,transparent)}
.progress-bar-danger{background-color:#d9534f}
.progress-striped .progress-bar-danger{background-image:-webkit-gradient(linear,0 100%,100% 0,color-stop(0.25,rgba(255,255,255,0.15)),
