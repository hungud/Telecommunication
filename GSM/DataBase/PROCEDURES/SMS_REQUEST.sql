CREATE OR REPLACE PROCEDURE SMS_REQUEST (pStreamID INTEGER DEFAULT -1, pNewSMS INTEGER DEFAULT 0)
IS
   --
   --Version=11
   --
   --v.11 Афросин А. 02.11.2015 - перенес логику уработы в JAVA.
   ...
   --
begin
  BEELINE_SMPP_API.SEND_CHECK_STATUS_SMS;
end;  