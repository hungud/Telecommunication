...
--#Version=11
-- 11. Матюнин. Поправлен запрос,чтобы оптимизировать план запроса. 
...
-- 5.  Котенков Добавлена выдача поля hand_block_date_end
  ...
  SELECT C.CONTRACT_ID, 
         ...
         NVL(CC.OPERATOR_ID, C.OPERATOR_ID) OPERATOR_ID, 
          --NVL (CC.PHONE_NUMBER_FEDERAL, C.PHONE_NUMBER_FEDERAL) PHONE_NUMBER_FEDERAL,  -- v11 такая конструкция ломала план запроса и неактуальна вообще
