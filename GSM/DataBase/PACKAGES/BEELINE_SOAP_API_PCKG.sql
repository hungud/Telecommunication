CREATE OR REPLACE PACKAGE BEELINE_SOAP_API_PCKG_afr AS
-- 
--#Version=8
--v8. Бакунов (Изменения вносил Алексеев. Были доработки). Добавлены новые функции
--v7. 23.01.2015 Афросин изменил получение статусов балансов
...
END BEELINE_SOAP_API_PCKG_afr;
/
CREATE OR REPLACE PACKAGE BODY BEELINE_SOAP_API_PCKG_afr AS
-- 
--#Version=5
