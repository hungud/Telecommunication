CREATE OR REPLACE PACKAGE AUTO_STATUS_ACTION_PCKG AS
--
--#Version=2
--
--2 17.11.2014 Крайнов. Поправка для удаления номеров при зависании.
--1 16.10.14 Крайнов. Создание пакета.
--
...
CREATE OR REPLACE PACKAGE BODY AUTO_STATUS_ACTION_PCKG AS
--
...
--GRANT EXECUTE ON AUTO_STATUS_ACTION_PCKG TO LONTANA_ROLE;

--GRANT EXECUTE ON AUTO_STATUS_ACTION_PCKG TO LONTANA_ROLE_RO;

--GRANT EXECUTE ON AUTO_STATUS_ACTION_PCKG TO CORP_MOBILE_ROLE;

--GRANT EXECUTE ON AUTO_STATUS_ACTION_PCKG TO CORP_MOBILE_ROLE_RO;

--GRANT EXECUTE ON AUTO_STATUS_ACTION_PCKG TO SIM_TRADE_ROLE;