...
--#Version=18
--
--v18. Афросин. 24.03.2015 Добавил параметр USE_ONLY_SMS_PROV в SEND_SMS и в SEND_SMS_MULTI, указывающий на то, 
--  что при отправке смс необходимо использовать только смс-провайдер, а не шлюз билайна
