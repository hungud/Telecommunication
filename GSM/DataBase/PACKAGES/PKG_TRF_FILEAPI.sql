CREATE OR REPLACE package PKG_TRF_FILEAPI as
--
-- Version = 2
--
-- 2. 2015.08.13. Крайнов. 
  ...
  /* Получение списка файлов по директории */     
  FUNCTION list_files(
    PATH VARCHAR2
    ) RETURN FILE_LIST IS
    LANGUAGE JAVA NAME 'ListVirtualDirectory.getList(java.lang.String) return oracle.sql.ARRAY';    
