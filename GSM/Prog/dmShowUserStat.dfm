object dmShowUserSt: TdmShowUserSt
  ...
  object qDopPhoneInfo: TOraQuery
    Session = MainForm.OraSession
    SQL.Strings = (
      'select * from DB_LOADER_SIM where PHONE_NUMBER=:PHONE_NUMBER')
    Left = 232
    Top = 568
    ParamData = <
      item
  ...
  object qRests: TOraQuery
    SQL.Strings = (
      ...
      'where '
        ...
        '                UPPER(MS_PARAMS.GET_PARAM_VALUE('#39'TARIFF_NAME_NO_' +
        'SHOW_VOICE'#39') ) not like '
      '                      UPPER('#39'%;'#39'|| '
      '                            TRIM ('
      
        '                                    (select TARIFF_NAME from tar' +
        'iffs where tariff_id = GET_CURR_PHONE_TARIFF_ID(:PHONE_NUMBER)) '
      '                                 )'
      '                            ||'#39';%'#39
      '                           ) '
      '               OR UNIT_TYPE <> '#39'VOICE'#39)
    Left = 424
    Top = 720
    ParamData = <
      item
  ...
  object qCheckUserPrivileges: TOraQuery
    Session = MainForm.OraSession
    SQL.Strings = (
      'SELECT'
      '  NVL(SHOW_BLOCK_UNBLOCK_BTN,0) SHOW_BLOCK_UNBLOCK_BTN,'
      '  NVL(RIGHT_CANCEL_CONTRACT,0) RIGHT_CANCEL_CONTRACT'
      '  '
      'FROM'
      '  USER_NAMES'
      'WHERE '
  ...
  object qVIP_Group: TOraQuery
    Session = MainForm.OraSession
    SQL.Strings = (
      'select Get_VipGroup(:PHONE_NUMBER) as tt from dual')
    Left = 656
    Top = 200
    ParamData = <
      item
    ...
    object qVIP_GroupTT: TFloatField
      FieldName = 'TT'
    end
  end
  object qSpiritTelecom: TOraQuery
    SQL.Strings = (
      'select case GET_ACCOUNT_NUMBER_BY_PHONE(:P_PHONE)'
      '         when 580721971 then--'#1085#1086#1084#1077#1088' '#1089#1095#1077#1090#1072' '#1089#1087#1083#1080#1090' '#1090#1077#1083#1077#1082#1086#1084#1072
      '          1'
      '        else'
      '          0'
      '        end IS_SHOW'
