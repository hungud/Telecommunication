object ReportActiveNumberNoContractsFrm: TReportActiveNumberNoContractsFrm
  Left = 203
  Top = 134
  Caption = #1040#1082#1090#1080#1074#1085#1099#1077' '#1085#1086#1084#1077#1088#1072' '#1073#1077#1079' '#1082#1086#1085#1090#1088#1072#1082#1090#1086#1074
  ClientHeight = 424
  ClientWidth = 778
  Color = clBtnFace
  ...
  object qReport: TOraQuery
    SQL.Strings = (
      ...
      '  V_ACTIVE_NUMBERS_OUT_CONTRACTS.PHONE_NUMBER,'
        ...
        '  GET_ABONENT_BALANCE(V_ACTIVE_NUMBERS_OUT_CONTRACTS.PHONE_NUMBE' +
        'R) BALANCE,'
      '  V_ACTIVE_NUMBERS_OUT_CONTRACTS.company_name,'
      '  V_ACTIVE_NUMBERS_OUT_CONTRACTS.login'
      'FROM'
