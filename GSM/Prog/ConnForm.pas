...
begin
  ...
  if (UpperCase(pSchemaName) = 'LONTANA')
     or(eSchema.text = 'GSM Корпорация') then
  begin
...
begin
  ...
  if (UpperCASE(edServer.Text) = UpperCase('ora.gsm-db.tarifer.ru:9634:GSMCORP')) and (eSchema.Text = 'GSM Корпорация')
