  ...
  inherited Panel2: TPanel
    ...
    inherited CRDBGrid1: TCRDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'PAYKEEPER_ENABLE'
          Title.Caption = #1044#1086#1089#1090#1091#1087#1077#1085' '#1076#1083#1103' PayKeeper(1-'#1076#1072', 0-'#1085#1077#1090')'
          Title.Font.Charset = DEFAULT_CHARSET
          Title.Font.Color = clWindowText
          Title.Font.Height = -11
          Title.Font.Name = 'MS Sans Serif'
    ...
    object Panel4: TPanel
      ...
      object PageControl2: TPageControl
        ...
        object TabSheet1: TTabSheet
          Caption = #1055#1072#1088#1072#1084#1077#1090#1088#1099' '#1086#1087#1086#1074#1077#1097#1077#1085#1080#1081
        ...
        object TabSheet2: TTabSheet
          Caption = #1055#1072#1088#1072#1084#1077#1090#1088#1099' '#1076#1077#1090#1072#1083#1080#1079#1072#1094#1080#1080
          ImageIndex = 1
  ...
  inherited qMain: TOraQuery
    ...
    SQLInsert.Strings = (
      'INSERT INTO ACCOUNTS'
        ...
        'EXT_NOTICE_BALANCE_CREDIT2,COMPANY_NAME, FILIAL_ID,new_pswd, SMS' +
        '_SENDER_NAME_ID, PAYKEEPER_ENABLE)'
      'VALUES'
        ...
        'MPANY_NAME, :FILIAL_ID, :new_pswd, :SMS_SENDER_NAME_ID, :PAYKEEP' +
        'ER_ENABLE)')
    SQLDelete.Strings = (
    ...
    SQLUpdate.Strings = (
      ...
      '  PAYKEEPER_ENABLE = :PAYKEEPER_ENABLE'
      'WHERE'
      '  ACCOUNT_ID = :Old_ACCOUNT_ID')
    SQLLock.Strings = (
    ...
    SQLRefresh.Strings = (
        ...
        'BALANCE_CREDIT2,COMPANY_NAME, FILIAL_ID,'
      'SMS_SENDER_NAME_ID, PAYKEEPER_ENABLE'
      ' FROM ACCOUNTS'
      'WHERE'
      '  ACCOUNT_ID = :ACCOUNT_ID')
    SQL.Strings = (
    ...
    object intgrfldMainPAYKEEPER_ENABLE: TIntegerField
      FieldName = 'PAYKEEPER_ENABLE'
    end
  end
