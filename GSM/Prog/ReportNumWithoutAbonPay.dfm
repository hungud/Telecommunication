object ReportNumWithoutAbonPayFrm: TReportNumWithoutAbonPayFrm
  Left = 426
  Top = 230
  Caption = #1054#1090#1095#1077#1090' '#1086' '#1085#1086#1084#1077#1088#1072#1093' '#1073#1077#1079' '#1090#1088#1072#1092#1080#1082#1072' '#1089' '#1072#1073#1086#1085#1077#1085#1090#1089#1082#1086#1081' '#1087#1083#1072#1090#1086#1081
  ClientHeight = 345
  ClientWidth = 785
  Color = clBtnFace
  ...
  object qReport: TOraQuery
    ...
    object qReportCONTRACT: TStringField
      FieldName = 'CONTRACT'
      Size = 6
    end
