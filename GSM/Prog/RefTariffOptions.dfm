inherited RefTariffOptionsForm: TRefTariffOptionsForm
  ...
  inherited qMain: TOraQuery
    ...
    SQLInsert.Strings = (
      'INSERT INTO TARIFF_OPTIONS'
        ...
        '  (TARIFF_OPTION_ID, OPERATOR_ID, OPTION_CODE, OPTION_NAME, DISC' +
        'R_SPISANIE, CAN_BE_TURNED_BY_OPERATOR, OPTION_NAME_FOR_AB)'
      'VALUES'
      
        '  (:TARIFF_OPTION_ID, :OPERATOR_ID, :OPTION_CODE, :OPTION_NAME, ' +
        ':DISCR_SPISANIE, :CAN_BE_TURNED_BY_OPERATOR, :OPTION_NAME_FOR_AB' +
        ')')
    SQLDelete.Strings = (
    ...
    SQLRefresh.Strings = (
        ...
        'DISCR_SPISANIE, CAN_BE_TURNED_BY_OPERATOR'
      'FROM TARIFF_OPTIONS'
      'WHERE'
  ...
  object qTariffOptionNewCost: TOraQuery
    SQLInsert.Strings = (
      ...
      '   MONTHLY_COST_FOR_BILLS, TURN_ON_COST_FOR_BILLS'
      '  )'
      'VALUES'
      ...
      '  )')
    SQLDelete.Strings = (
      'delete from TARIFF_OPTION_NEW_COST'
      'where'
      ' TARIFF_OPTION_NEW_COST_ID = :Old_TARIFF_OPTION_NEW_COST_ID')
    SQLUpdate.Strings = (
      'UPDATE TARIFF_OPTION_NEW_COST'
      'SET'
      '  TURN_ON_COST = :TURN_ON_COST,'
      '  MONTHLY_COST = :MONTHLY_COST,'
      '  TURN_ON_COST_FOR_BILLS = :TURN_ON_COST_FOR_BILLS,'
      '  MONTHLY_COST_FOR_BILLS = :MONTHLY_COST_FOR_BILLS,'
      '  TARIFF_ID = :TARIFF_ID'
      'WHERE'
      '  TARIFF_OPTION_NEW_COST_ID = :Old_TARIFF_OPTION_NEW_COST_ID '
      '  AND TARIFF_OPTION_COST_ID = :Old_TARIFF_OPTION_COST_ID'
      '  AND TARIFF_ID = :Old_TARIFF_ID'
      '  AND TURN_ON_COST = :Old_TURN_ON_COST'
      '  AND MONTHLY_COST = :Old_MONTHLY_COST'
      '  AND TURN_ON_COST_FOR_BILLS = :Old_TURN_ON_COST_FOR_BILLS'
      '  AND MONTHLY_COST_FOR_BILLS = :Old_MONTHLY_COST_FOR_BILLS'
      ''
      ''
      '-- 1 row(s) affected.')
    SQL.Strings = (
